...
def test_settlement_matched_when_p01_matched_by_deduct_date(db):
    ...
    _settlement(db, "1A999003", "2026-07-25", "2026-07-27", 23600)
...
def test_settlement_unmatched_without_p01_or_kowdl(db):
    _settlement(db, "1A999003", "2026-07-25", "2026-07-27", 23600)   # no P01, no same-day KO wdl
...
def test_settlement_still_matches_same_day_kowdl_without_p01(db):
    ...
    _settlement(db, "1A999003", "2026-07-27", "2026-07-27", 23600)
